  ...
  return (
    <div className="relative group w-full max-w-md mx-auto mb-12">
      ...
      <div className="relative flex items-center">
        ...
        />
        <div className="absolute right-3 px-2 py-1 bg-gray-100 dark:bg-white/10 rounded-md text-xs font-medium text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-white/5">
          ⌘K
        </div>
      </div>
    </div>
